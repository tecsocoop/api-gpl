	...
	<fieldset>
		...
		<table class="tabladatos">
			...
			<tr>
				...
				<td class="normal">	
					<html:select name="vencimientoAdapterVO" property="vencimiento.primeroSemana.id" styleClass="select">
						<html:optionsCollection name="vencimientoAdapterVO" property="listSiNo" label="value" value="id" />
					</html:select>
				</td>
			</tr>
			<tr>
				...
				<td class="normal">	
					<html:select name="vencimientoAdapterVO" property="vencimiento.ultimoSemana.id" styleClass="select">
						<html:optionsCollection name="vencimientoAdapterVO" property="listSiNo" label="value" value="id" />
					</html:select>
				</td>
			</tr>
